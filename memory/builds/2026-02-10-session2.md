...
### 6. `--month` flag ✅
- Added `-m, --month` for 30-day summary
- Groups by week (This week, Last week, 2 weeks ago, etc.)
- Shows entry totals per week with active days
- Calculates overall totals and averages

**Commit:** `bf8418fc feat(devlog): add --month flag for 30-day summary by week`
