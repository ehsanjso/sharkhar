...
import { DEFAULT_PRICE_FEEDS } from './types-multi';
export class MultiPriceTracker {
    prices = new Map();
    sockets = new Map();
    assets;
    constructor(assets = ['BTC', 'ETH']) {
        this.assets = assets;
...
// Singleton instance
let tracker = null;
export function getPriceTracker(assets) {
    if (!tracker) {
        tracker = new MultiPriceTracker(assets);
    }
    return tracker;
}
//# sourceMappingURL=multi-price-tracker.js.map